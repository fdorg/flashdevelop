...
namespace HaXeContext.Completion.Haxe3
{
    ...
    class CodeCompleteTests2 : ASCompleteTests
    {
        ...
        static IEnumerable<TestCaseData> OnCharAndReplaceTextIssue3055TestCases
        {
            get
            {
                yield return new TestCaseData("BeforeOnCharAndReplaceText_issue3055_1", '.', false)
                    .Returns(CodeCompleteTests.ReadAllText("AfterOnCharAndReplaceText_issue3055_1"))
                    .SetName("this.<complete> Issue 3055. Case 1")
                    .SetDescription("https://github.com/fdorg/flashdevelop/issues/3055");
                yield return new TestCaseData("BeforeOnCharAndReplaceText_issue3055_2", '.', false)
                    .Returns(CodeCompleteTests.ReadAllText("AfterOnCharAndReplaceText_issue3055_2"))
                    .SetName("this.<complete> Issue 3055. Case 2")
                    .SetDescription("https://github.com/fdorg/flashdevelop/issues/3055");
                yield return new TestCaseData("BeforeOnCharAndReplaceText_issue3055_3", '.', false)
                    .Returns(CodeCompleteTests.ReadAllText("AfterOnCharAndReplaceText_issue3055_3"))
                    .SetName("this.<complete> Issue 3055. Case 3")
                    .SetDescription("https://github.com/fdorg/flashdevelop/issues/3055");
                yield return new TestCaseData("BeforeOnCharAndReplaceText_issue3055_4", '.', false)
                    .Returns(CodeCompleteTests.ReadAllText("AfterOnCharAndReplaceText_issue3055_4"))
                    .SetName("super.<complete> Issue 3055. Case 4")
                    .SetDescription("https://github.com/fdorg/flashdevelop/issues/3055");
                yield return new TestCaseData("BeforeOnCharAndReplaceText_issue3055_5", '.', false)
                    .Returns(CodeCompleteTests.ReadAllText("AfterOnCharAndReplaceText_issue3055_5"))
                    .SetName("super.<complete> Issue 3055. Case 5")
                    .SetDescription("https://github.com/fdorg/flashdevelop/issues/3055");
                yield return new TestCaseData("BeforeOnCharAndReplaceText_issue3055_6", '.', false)
                    .Returns(CodeCompleteTests.ReadAllText("AfterOnCharAndReplaceText_issue3055_6"))
                    .SetName("super.<complete> Issue 3055. Case 6")
                    .SetDescription("https://github.com/fdorg/flashdevelop/issues/3055");
            }
        }

        static IEnumerable<TestCaseData> OnCharAndReplaceTextIssue3117TestCases
        {
            get
            {
                yield return new TestCaseData("BeforeOnCharAndReplaceText_issue3117_1", ' ', false)
                    .Returns(CodeCompleteTests.ReadAllText("AfterOnCharAndReplaceText_issue3117_1"))
                    .SetName("import StringTools.contains in c<complete> Issue 3117. Case 1")
                    .SetDescription("https://github.com/fdorg/flashdevelop/issues/3117");
                yield return new TestCaseData("BeforeOnCharAndReplaceText_issue3117_2", ' ', false)
                    .Returns(CodeCompleteTests.ReadAllText("AfterOnCharAndReplaceText_issue3117_2"))
                    .SetName("import StringTools.contains as c<complete> Issue 3117. Case 1")
                    .SetDescription("https://github.com/fdorg/flashdevelop/issues/3117");
            }
        }
    ...
    class CodeCompleteTests4 : ASCompleteTests
    {
        ...
        static IEnumerable<TestCaseData> GetExpressionType_InferVariableTypeIssue2993TestCases
        {
            get
            {
                yield return new TestCaseData(CodeCompleteTests.ReadAllText("GetExpressionType_Type_issue2993_1"))
                    .Returns(null)
                    .SetName("var v = 'v<complete> Issue 2993. Case 1")
                    .SetDescription("https://github.com/fdorg/flashdevelop/issues/2993");
            }
        }

        static IEnumerable<TestCaseData> GetExpressionType_InferVariableTypeIssue2963TestCases
        {
            get
            {
                yield return new TestCaseData(CodeCompleteTests.ReadAllText("GetExpressionType_Type_issue2963_1"))
                    .Returns(new ClassModel { Name = "Dynamic", Flags = FlagType.Class | FlagType.Abstract, InFile = FileModel.Ignore })
                    .SetName("for(v in v<complete> Issue 2963. Case 1")
                    .SetDescription("https://github.com/fdorg/flashdevelop/issues/2963");
            }
        }
