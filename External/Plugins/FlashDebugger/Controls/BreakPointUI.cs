...
namespace FlashDebugger
{
    class BreakPointUI : DockPanelControl, ASCompletionListBackend.IBackendFileGetter
    {
        ...
        void dgv_EditingControlShowing(object sender, DataGridViewEditingControlShowingEventArgs e)
        {
            ...
            {
                var listHost =
                    new Controls.ImmediateUI.TextBoxTarget((FlashDebugger.Controls.ImmediateUI.TextBoxEx) e.Control);
    ...
    public class DataGridViewTextBoxExEditingControl : Controls.ImmediateUI.TextBoxEx, IDataGridViewEditingControl
    {
