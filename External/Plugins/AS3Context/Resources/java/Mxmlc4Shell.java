...
/**
 * Flex 4 compiler host
 *
 * Author: Philippe Elsass
 * 
 * Building: javac -classpath "C:\path\to\flex_sdk_4\lib\mxmlc.jar;." Mxmlc4Shell.java
 * Running: java -classpath "C:\path\to\flex_sdk_4\lib\mxmlc.jar;." Mxmlc4Shell
 */
class Mxmlc4Shell
{
    static public void main(String[] args)
    {
        ...
        try
        {
            ...
            while (true)
            {
                ...
                try
                {
                    flex2.tools.Mxmlc.main(cmd.split(";"));
                }
                catch (ExitSecurityException ese)
                {
                    System.out.println("Done(" + ese.exitcode + ")");
                }
