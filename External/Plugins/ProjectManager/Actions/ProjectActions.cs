...
namespace ProjectManager.Actions
{
	...
	public class ProjectActions
	{
		...
		private void PatchFbProject(AS3Project project)
		{
			...
			{
				projectPath = isFlex ? DefaultProjectTemplates.As3AirMobileFlex : DefaultProjectTemplates.As3AirMobilePure;
			...
			else
			{
				...
				projectPath = isFlex ? DefaultProjectTemplates.As3AirFlex : DefaultProjectTemplates.As3AirPure;
