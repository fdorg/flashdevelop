...
namespace AirProperties.Controls
{
    ...
    public class TriStateTreeView : System.Windows.Forms.TreeViewEx
    {
        ...
        // </remarks>
        public enum TriStateStyles : int
        {
            Standard = 0,
            Installer
        };
        ...
        public TriStateTreeView()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                var chkGraphics = System.Drawing.Graphics.FromImage(bmp);
                switch (i)
                {
        ...
        protected void UpdateParentState(System.Windows.Forms.TreeNode tn)
        {
            ...
            {
                if (tnChild.StateImageIndex == (int)CheckedState.Checked) CheckedNodes++;
            ...
            // Jaeha's code
            else if (CheckedNodes == tn.Nodes.Count) tn.StateImageIndex = (int) CheckedState.Checked;
