...
namespace ProjectManager.Building
{
    ...
    public class SwfmillLibraryWriter : XmlTextWriter
    {
        ...
        void AddImage(LibraryAsset asset)
        {
        ...
        void AddSound(LibraryAsset asset)
        {
        ...
        void AddFont(LibraryAsset asset)
        {
        ...
        void AddSwf(LibraryAsset asset)
        {
            WriteStartElement("clip");
        ...
        void AddStampAttributes(string path)
        {
