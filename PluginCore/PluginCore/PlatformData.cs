...
namespace PluginCore
{
    ...
    public class PlatformData
    {
        ...
        {
            if (!SupportedLanguages.ContainsKey(lang)) return "16.0";
            var platforms = SupportedLanguages[lang.ToLower()].Platforms;
            if (!platforms.ContainsKey(FLASHPLAYER_PLATFORM)) return "16.0";
        ...
        {
            if (!SupportedLanguages.ContainsKey(lang)) return "27";
            var platforms = SupportedLanguages[lang.ToLower()].Platforms;
            if (!platforms.ContainsKey(FLASHPLAYER_PLATFORM) || !platforms.ContainsKey(platformName)) return "27";
