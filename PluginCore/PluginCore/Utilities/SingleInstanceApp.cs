...
namespace PluginCore.Utilities
{
    ...
    public class SingleInstanceApp
    {
        ...
        void Init() => _notifcationWindow = new SIANativeWindow();
        ...
        public static bool NotifyExistingInstance(object message) => _theInstance.Exists && _theInstance.NotifyPreviousInstance(message);
