...
6. Running/debugging the application on the device:
	...
	- edit 'bat\RunApplication.bat' and change the run target 'goto desktop' by 'goto android-debug'
...
7. Packaging for release:
	...
	- run 'bat\PackageApplication.bat' and select Android/normal target
